...
*/
  ...
  handleSliderChangeCommitted = (initialTaskValues) => {
    console.log(
      "HANDLESLIDERCHANGECOMMITED: trying to reset initialState, get ready ..."
    );
    ...
    console.log(
      "HANDLESLIDERCHANGECOMMITED: this should be the origianl initialState " +
        JSON.stringify(initialStateUpdated, null, 2)
    );
    ...
    console.log(
      "HANDLESLIDERCHANGECOMMITED: this is the new state and should be the origianl initialState " +
        JSON.stringify(this.state, null, 2)
    );

    // this.setState({ initialState: null }); // reset after slider use
    console.log(
      "HANDLESLIDERCHANGECOMMITED: reset initialState ... at least tried - END"
    );
  };
